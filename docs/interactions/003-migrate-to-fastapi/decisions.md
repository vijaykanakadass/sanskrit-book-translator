...
## Python + FastAPI for backend (replacing Express)

**Date:** 2026-03-05
**Status:** Accepted
**Supersedes:** React + Vite + Express stack decision (backend portion only)
...
- AI SDKs (Claude, OpenAI, Sarvam) have first-class Python support
